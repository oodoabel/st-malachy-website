...
const ExecutiveCard = ({ executive }: { executive: Executive }) => {
  return (
    <div className="group relative bg-white border-2 border-[var(--border-color)] rounded-2xl overflow-hidden hover:border-blue-500/50 shadow-lg hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-500">
      ...
      <div className="p-6 relative">
        ...
        <h3 className="text-lg font-bold text-[var(--text-primary)] leading-tight group-hover:text-blue-600 transition-colors">
          {executive.name}
        </h3>
      </div>
    </div>
    ...
    <section className="py-24 bg-gradient-to-b from-[var(--secondary-bg)] to-white relative">
      <div className="mx-auto max-w-[1400px] px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          ...
          <Link
            href="/executives"
            className="group inline-flex items-center gap-2 text-[var(--text-secondary)] font-bold text-sm uppercase tracking-widest hover:text-[var(--primary-red)] transition-colors"
          >
            View Full Council
